...
public class Motorcycle extends Vehicle {
    ...
    public Motorcycle(String id, String name, String model, double rentalRate, boolean hasSidecar) {
        super(id, name, model, rentalRate, true); // Pass model instead of default
